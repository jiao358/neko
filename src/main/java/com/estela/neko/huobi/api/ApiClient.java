...
import com.estela.neko.huobi.response.*;
...
public class ApiClient {
    ...
    static final int CONN_TIMEOUT = 5*3;
    static final int READ_TIMEOUT = 5*3;
    static final int WRITE_TIMEOUT = 5*3;
    ...
    public BalanceResponse balance(String accountId) {
        BalanceResponse
            resp = get("/v1/account/accounts/" + accountId + "/balance", null, new TypeReference<BalanceResponse<Balance>>() {
        });
        return resp;
    }
    ...
    public SubmitcancelResponse submitcancel(String orderId) {
        SubmitcancelResponse
            resp = post("/v1/order/orders/" + orderId + "/submitcancel", null, new TypeReference<SubmitcancelResponse>() {
        });
        return resp;
    }
    ...
    public BatchcancelResponse submitcancels(List orderList) {
          ...
          BatchcancelResponse
              resp = post("/v1/order/orders/batchcancel", parameterMap, new TypeReference<BatchcancelResponse<Batchcancel<List, List<BatchcancelBean>>>>() {
          });
          return resp;
    }
    ...
    public MatchresultsOrdersDetailResponse matchresults(String orderId) {
        MatchresultsOrdersDetailResponse
            resp = get("/v1/order/orders/" + orderId + "/matchresults", null, new TypeReference<MatchresultsOrdersDetailResponse>() {
        });
        return resp;
    }
    ...
    public IntrustDetailResponse intrustOrdersDetail(IntrustOrdersDetailRequest req) {
        ...
        IntrustDetailResponse
            resp = get("/v1/order/orders/", map, new TypeReference<IntrustDetailResponse<List<IntrustDetail>>>() {
        });
        return resp;
    }
